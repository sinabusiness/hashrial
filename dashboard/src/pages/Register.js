    ...
    <div style={{ minHeight:"100vh", background:"var(--bg)", display:"flex", alignItems:"center", justifyContent:"center", padding:20 }}>
      <div style={{ width:"100%", maxWidth:420 }}>
        ...
        <div style={{ background:"var(--bg2)", border:"1px solid var(--border)", borderRadius:"var(--r2)", padding:"28px 32px" }}>
          <h1 style={{ fontSize:17, fontWeight:600, marginBottom:6 }}>Create your account</h1>
          <div style={{ fontSize:12, color:"var(--text2)", marginBottom:22, lineHeight:1.6 }}>
            Your username will be your pool identity. Choose carefully — it cannot be changed.
          </div>
          ...
          <form onSubmit={submit}>
            {[
              { key:"username", label:"Username", type:"text",     placeholder:"e.g. ali_miner",     hint:"3–20 chars, lowercase letters/numbers/underscore" },
              { key:"email",    label:"Email",    type:"email",    placeholder:"you@example.com" },
              { key:"password", label:"Password", type:"password", placeholder:"Min 10 characters", minLength:10 },
            ].map(f => (
